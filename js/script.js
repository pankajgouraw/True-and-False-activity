$(function() {
    ...
    function displayQueastions() {
        for (questionIndex; questionIndex < questionPerPage; questionIndex++) {
            ...
            let html = `
            <div class='questionContainer animated fadeInUp'>
                    ...
                    <div class='optContainer'>
                        <div class='ans'>
                            <label class='labelContainer'>
                                <input type='radio' id='corrAns0${questionIndex}' class="corrAns" value='' name='data${questionIndex}'> <span class='checkmark'></span>
                            </label>
                        ...
                        <div class='ans'>
                            <label class='labelContainer'>
                                <input type='radio' id='opt1${questionIndex}' value='' name='data${questionIndex}'><span class='checkmark'>
                                     </span>
                            </label>
            ...
            $.each(ansDiv, function(index, value) {
                    ...
                    if (radioLength > 0) {
                        if ($(this).hasClass('corrAns')) {
                            if ($(this).is(':checked')) {
                                let rightSign = $(this).parent().parent().parent().find('.right');
                                rightSign.fadeIn();
                                totalCorrectAns++;
                            } else {
                                let wrongSign = $(this).parent().parent().parent().find('.wrong');
                                wrongSign.fadeIn();
                            }
                        }
                    }
    ...
    $('#showAns').click(function() {
        ...
        $('.mcqWrapper #mcqWrapper .wrong').hide();
        $('.mcqWrapper #mcqWrapper .right').show();
